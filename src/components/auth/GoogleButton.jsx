...
export default function GoogleButton({ label = 'Continue with Google', onSuccess, onError, disabled }) {
  ...
  return (
    <button
      ...
      className="flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-slate-300 bg-white text-sm font-semibold text-[#172033] shadow-sm transition-all duration-150 hover:bg-slate-50 hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 focus:border-[#2563EB] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
    >
      {loading ? (
